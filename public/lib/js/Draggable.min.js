...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function (a, b, c) {
    var d,
      ...
      for (var c, d, e, f, g, h, i, j, k = xa(a, pa), l = xa(a.parentNode, qa), m = za(a, k, l, !1, !b); (a = a.parentNode) && a.parentNode && a !== t;) k = l, l = xa(a.parentNode, k === pa ? qa : pa), i = za(a, k, l), c = m[0], d = m[1], e = m[2], f = m[3], g = m[4], h = m[5], m[0] = c * i[0] + d * i[2], m[1] = c * i[1] + d * i[3], m[2] = e * i[0] + f * i[2], m[3] = e * i[1] + f * i[3], m[4] = g * i[0] + h * i[2] + i[4], m[5] = g * i[1] + h * i[3] + i[5];
      ...
      for (b = 0; f > b; b++) if (c = a[b], Ea(c)) for (d = c.length, d = 0; d < c.length; d++) e.push(c[d]);else c && 0 !== c.length && e.push(c);

      return e;
    },
        Ga = "ontouchstart" in t && "orientation" in window,
        Ha = function (a) {
      for (var b = a.split(","), c = (void 0 !== v.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== v.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : a).split(","), d = {}, e = 4; --e > -1;) d[b[e]] = c[e], d[c[e]] = b[e];
      ...
      if (b) if (1 !== e && b instanceof Array) {
        if (j.end = g = [], i = b.length, "object" == typeof b[0]) for (h = 0; i > h; h++) g[h] = N(b[h], e);else for (h = 0; i > h; h++) g[h] = b[h] * e;
        c += 1.1, d -= 1.1;
      ...
      var h,
        ...
        }, isNaN(g.maxDuration) ? 2 : g.maxDuration, isNaN(g.minDuration) ? 0 === j || "object" == typeof a && a.resistance > 1e3 ? 0 : .5 : g.minDuration, j), g.fastMode || (i && (i._suspendTransforms = !0), h.render(h.duration(), !0, !0), eb(!0, !0), Qa.endX = Qa.x, Qa.endY = Qa.y, za && (Qa.endRotation = Qa.x), h.play(0), eb(!0, !0), i && (i._suspendTransforms = !1))) : u && Qa.applyBounds();
      },
          jb = function (a) {
        var b,
            c,
        ...
        return f = f && z > f ? f * f : z, "function" == typeof a ? function (h) {
          ...
          for (var c, d, e, g, h = a.length, i = 0, j = z; --h > -1;) e = a[h], c = e.x - b.x, d = e.y - b.y, g = c * c + d * d, j > g && (i = h, j = g);
        ...
        if (h && !Qa.isPressed && a && ("mousedown" !== a.type && "pointerdown" !== a.type || c || !(A() - bb < 30) || !Ha[Qa.pointerEvent.type])) {
          ...
          if (ra = !la || Ea === Fa || Qa.vars.allowNativeTouchScrolling === !1 || Qa.vars.allowContextMenu && a && (a.ctrlKey || a.which > 2) ? !1 : Ea ? "y" : "x", B ? a = $(a, !0) : ra || Qa.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = U = a.changedTouches[0], Y = a.identifier) : a.pointerId ? Y = a.pointerId : U = Y = null, H++, P(db), k = Qa.pointerY = a.pageY, j = Qa.pointerX = a.pageX, (ra || Qa.autoScroll) && Z(d.parentNode), !d.parentNode || !Qa.autoScroll || i || za || !d.parentNode._gsMaxScrollX || C.parentNode || d.getBBox || (C.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(C)), kb(), Qa.tween && Qa.tween.kill(), Qa.isThrowing = !1, b.killTweensOf(i || d, !0, Ua), i && b.killTweensOf(d, !0, {
            scrollTo: 1
          }), Qa.tween = Qa.lockedAxis = null, (g.zIndexBoost || !za && !i && g.zIndexBoost !== !1) && (d.style.zIndex = Sa.zIndex++), Qa.isPressed = !0, v = !(!g.onDrag && !Qa._listeners.drag), !za) for (e = Ta.length; --e > -1;) ba(Ta[e], "cursor", g.cursor || "move");
          ia(Qa, "press", "onPress");
        }
      },
          qb = function (a) {
        ...
        if (h && Qa.isPressed && (!a || null == Y || c || !(a.pointerId && a.pointerId !== Y || a.changedTouches && !Ka(a.changedTouches, Y)))) {
          ...
          if (Q(db), !za) for (f = Ta.length; --f > -1;) ba(Ta[f], "cursor", g.cursor || "move");
      ...
      da = Sa.get(this.target), da && da.kill(), this.startDrag = function (a, b) {
        ...
        if ("soft" !== a) {
          for (j = Ta.length; --j > -1;) k = Ta[j], Ia(k, "mousedown", pb), Ia(k, "touchstart", pb), Ia(k, "click", ub, !0), za || ba(k, "cursor", g.cursor || "move"), ba(k, "touchCallout", "none"), ba(k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), sa(k) && ba(k.ownerSVGElement || k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), this.vars.allowContextMenu || Ia(k, "contextmenu", cb);
        ...
        var b,
            c,
            e = Qa.isDragging;
        if (!za) for (b = Ta.length; --b > -1;) ba(Ta[b], "cursor", null);

        if ("soft" !== a) {
          for (b = Ta.length; --b > -1;) c = Ta[b], ba(c, "touchCallout", null), ba(c, "touchAction", null), Ja(c, "mousedown", pb), Ja(c, "touchstart", pb), Ja(c, "click", ub), Ja(c, "contextmenu", cb);
        ...
        return Qa.isThrowing = !1, b.killTweensOf(i || d, !0, Ua), Qa.disable(), b.set(Ta, {
          clearProps: "userSelect"
        }), delete E[d._gsDragID], Qa;
    ...
    Ta.constructor = Sa, Ta.pointerX = Ta.pointerY = Ta.startX = Ta.startY = Ta.deltaX = Ta.deltaY = 0, Ta.isDragging = Ta.isPressed = !1, Sa.version = "0.16.4", Sa.zIndex = 1e3, Ia(s, "touchcancel", function () {}), Ia(s, "contextmenu", function (a) {
      var b;
