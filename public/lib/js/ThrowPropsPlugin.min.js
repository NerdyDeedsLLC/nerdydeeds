...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (r, b, S, T) {
    var _,
      ...
      } else for (; -1 < --u;) (s = (i = t[u]) - e) < 0 && (s = -s), s < p && o <= i && i <= r && (f = u, p = s);
    ...
    return (e.constructor = N).version = "0.11.0", N.API = 2, N._autoCSS = !0, N.defaultResistance = 100, N.defaultUnitFactors = {
      ...
      if (t.linkedProps) for (d = t.linkedProps.split(","), g = {}, h = 0; h < d.length; h++) (i = t[n = d[h]]) && (c = void 0 !== i.velocity && "number" == typeof i.velocity ? Number(i.velocity) || 0 : (l = l || T.getByTarget(e)) && l.isTrackingProp(n) ? l.getVelocity(n) : 0, s = "function" == typeof e[n] ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : e[n] || 0, g[n] = s + D(c, v, y, m));

      for (n in t) if ("resistance" !== n && "checkpoint" !== n && "preventOvershoot" !== n && "linkedProps" !== n && "radius" !== n) {
        if ("function" == typeof (i = t[n]) && (i = i(o, e)), "number" == typeof i) c = Number(i) || 0;else if ("object" != typeof i || isNaN(i.velocity)) {
