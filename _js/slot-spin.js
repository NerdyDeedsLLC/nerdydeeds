...
class CONTENTSPINNER {
      constructor( htmlContainerObject={}, 
                   contentHeight=1, 
                   maxSerial=1, 
                   currentContent='', 
                   contentPrefix='', 
      ...
      this.createNode = () => {
         ...
         if(this.internalTimer <= 1000) this.internalTimer *= 1.5;
         else                           this.internalTimerPaused = true;
      ...
      this.cycleElements = () => {
         ...
         if(!this.internalTimerPaused){
            ...
            setTimeout(()=>{this.updateInternalTimer(fc, 30); this.restartSequence();}, 3000);
         }
      };
