        ...
        .add([
            ...
            gsTLdeviceDrops = new TimelineMax({id:'deviceDrops'})
                ...
                .add([
                    ...
                    , TweenMax.to(scene,  0.35,   {delay:0,       scaleX:5, scaleY:0.33, left:'250vw', marginLeft:0, ease:Back.easeIn})
                ])
            ...
            , gsTLsignRotator = new TimelineMax({id:'signRotator'})
                .add([
                      TweenMax.to(signs,  0.5,    {delay:1.75,    rotation:'-=180', ease:Bounce.easeOut})
                ])
                .add([
                      TweenMax.to(signs,  2.5,     {delay:2,       rotationY:'540deg', transformPerspective:2000, ease:Elastic.easeOut})
